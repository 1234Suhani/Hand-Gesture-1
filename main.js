...
var Camera = document.getElementById("Captured_img");
Webcam.attach('#Camera');
  ...
  classifier= ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/d9frJDnKY/model.json', modelLoaded);
